...
$sql="SELECT users.*, user_level.* FROM users INNER JOIN user_level ON users.user_level= user_level.id WHERE users.mobile='$distributor_number' AND users.outlet_id='$outlet_id'";
...
if(mysqli_num_rows($result)==1)
{
  ...
  { 
   ...
   $display=1;
   $sql="SELECT * FROM user_ledger WHERE user_id='$user_id'";
...
{
    echo "<script> alert('Distributor Mobile Number Not Found In Outlets')</script>";
}    
...
<div class="col-md-4">
        ...
        $ref_numbered=$ref_num_row['mobile']; ?>
         ...
         <p>Reffered Mobile:<span style="margin-left: 4%;"><?php echo $ref_numbered;?></span></p>
                                        </div>
 ...
 <div style="padding-right: 5%!important;">
     ...
     <table id="tb" class="display nowrap" cellspacing="0" width="100%" style="margin-right: 5%;">
        <thead>
            <tr>
                <th>Name</th>
                <th>Type</th>
