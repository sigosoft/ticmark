...
$check="SELECT * FROM auth WHERE type='Outlet' AND id='$outlet_id'";
...
if($pass!=$old_password)
{
    ...
    echo "<script> alert('Wrong Password');window.location.href = 'setting.php';</script>";
...
else
{
  ...
  else 
  {
    ...
    $sql="UPDATE auth SET password='$password' WHERE type='Outlet' AND id='$outlet_id'";
