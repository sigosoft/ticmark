...
if(mysqli_num_rows($result)==1)
{
  ...
  { 
   ...
   $sql="SELECT * FROM outlet_sale WHERE user_id='$user_id' AND outlet_id='$outlet_id'";
...
{
    echo "<script> alert('Distributor Mobile Number Not Found In Outlet')</script>";
}    
...
<form action="" method="POST">  
         <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">User Purchase Report </h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    <form role="form">
                                        <!-- text input -->
