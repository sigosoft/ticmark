...
$sql="SELECT * FROM users WHERE block=1";
...
<?php require 'sidebar.php'; ?>
            ...
            <aside class="right-side">
                <center><h2 style="font-family: "Times New Roman", Times, serif;">Blocked User List</h2></center> 
        ...
        ?>
            ...
            <tr>
                ...
                <td><a href="user_details.php?id=<?php echo $row['user_id'];?>">View</a></td>
                 <td><a href="user_unblock.php?id=<?php echo $row['user_id'];?>" onclick="return confirm('Are you sure?')">Unblock</a></td>
