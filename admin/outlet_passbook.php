...
if(isset($_POST['submit']))
{
    ...
    if(move_uploaded_file($_FILES["passbook"]["tmp_name"], $target))
    {
     ...
     $sql="UPDATE auth SET passbook='$passbook' WHERE id='$outlet_id'";
     mysqli_query($conn,$sql);
     echo "<script> alert('Added Successfully');window.location.href = 'manage_outlet.php';</script>";
...
<?php require 'sidebar.php'; ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Edit Passbook</h3>
                                </div>
            ...
            <label for="grid-input-1" class="col-md-3 control-label">Passbook</label>
            <div class="col-md-9">
