...
$query="SELECT(SELECT SUM(price) FROM outlet_sale WHERE outlet_id='$outlet_id' AND date(timestamp)='$current') AS daily,(SELECT SUM(price) FROM outlet_sale WHERE outlet_id='$outlet_id') AS total ";
...
$pquery="SELECT SUM(price) AS period FROM outlet_sale WHERE outlet_id='$outlet_id' AND  (DATE(`timestamp`) >= '$start' AND DATE(`timestamp`) <= '$end' )";
