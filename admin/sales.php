...
$sql="SELECT * FROM outlet_sale WHERE date(timestamp)='$current'";



$query="SELECT(SELECT SUM(price) FROM outlet_sale WHERE date(timestamp)='$current') AS daily,(SELECT SUM(price) FROM outlet_sale) AS total ";
...
$pquery="SELECT SUM(price) AS period FROM outlet_sale WHERE (DATE(`timestamp`) >= '$start' AND DATE(`timestamp`) <= '$end')";
...
$sql="SELECT * FROM outlet_sale WHERE (DATE(`timestamp`) >= '$start'AND DATE(`timestamp`) <= '$end')";
        ...
        ?>
            ...
            <tr>
                ...
                <td><?php echo $row['price'];?></td>
                 ...
                 $loc="SELECT * FROM  auth WHERE id='$outlet_id'";
                 $locresult=mysqli_query($conn,$loc);
