...
<?php require 'sidebar.php'; ?>
            ...
            <aside class="right-side">
                <center><h2 style="font-family: "Times New Roman", Times, serif;">Product List</h2></center> 
            ...
            <tr>
                ...
                <td><?php echo $row['timestamp'];?></td>
                 ...
                 <td><a href="edit_product.php?id=<?php echo $row['id'];?>">Edit</a> </td>
                  ...
                  <!-- <a href="product_delete.php?id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure?')">Delete</a> -->
