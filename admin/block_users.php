...
$sql="SELECT * FROM users WHERE block=0";
...
<?php require 'sidebar.php'; ?>
        ...
        ?>
            ...
            <tr style="color:<?php echo $color; ?>">
                ...
                <td><a href="user_block.php?id=<?php echo $row['user_id'];?>" onclick="return confirm('Are you sure?')" >Block</a></td>
