...
$sql="SELECT users.*, payment_request.* FROM users INNER JOIN payment_request ON users.user_id=payment_request.UserID WHERE payment_request.Status = 'Waiting'";
...
<?php require 'sidebar.php'; ?>
            ...
            <aside class="right-side">
                <center><h2 style="font-family: "Times New Roman", Times, serif;">Payment Request</h2></center> 
