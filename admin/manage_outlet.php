...
$sql="SELECT * FROM auth WHERE type='outlet'";
...
<?php require 'sidebar.php'; ?>
            ...
            <aside class="right-side">
                <center><h2 style="font-family: "Times New Roman", Times, serif;">Outlet List</h2></center> 
        ...
        ?>
            ...
            <tr>
                ...
                <td><a href="outlet_details.php?id=<?php echo $row['id'];?>">View</a></td>
