...
if(isset($_POST['submit']))
{
    ...
    if(move_uploaded_file($_FILES["idproof"]["tmp_name"], $target))
    {
     ...
     $sql="UPDATE auth SET idproof='$idproof' WHERE id='$outlet_id'";
...
<?php require 'sidebar.php'; ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Edit ID Proof</h3>
                                </div>
            ...
            <label for="grid-input-1" class="col-md-3 control-label">ID Proof</label>
            <div class="col-md-9">
